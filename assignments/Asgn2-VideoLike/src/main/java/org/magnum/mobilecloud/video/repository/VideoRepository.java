...
// persistence technology-specific Repository subinterface located under the
// configured base package and creates a bean instance for it. See: http://goo.gl/JkGr0Y

// Also see Spring guide at http://goo.gl/xpZfpW
// NOTE from the guide: At runtime, Spring Data REST will create an implementation
// of this interface automatically. Then it will use the @RepositoryRestResource
// annotation to direct Spring MVC to create RESTful endpoints at the given path.
